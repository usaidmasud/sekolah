                            ...
                            <ul class="chat">
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img class="img-circle img-responsive" width="40px" src="<?php echo base_url().'assets/images/forum.png' ?>">
                                    </span>
                                    <div class="chat-body clearfix">
                                        <div class="header">
                                            <strong class="primary-font"><?php echo $row->oleh ?></strong> - <a href="<?php echo base_url().'dashboard/komenhapus/'.$forum['id'].'/'.$row->id ?>">hapus</a>
