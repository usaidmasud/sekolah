                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('dashboard/alumni_edit') ?>
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <label>NIS</label>
                                    <input value="<?php echo $record['nis'] ?>" name="nis" type="text" class="form-control">
                          ...
                          <!--   </div>
                            <div class="col-sm-5"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $record['angkatan'] ?>" name="angkatan" type="text" class="form-control" placeholder="Kelas" id="nama" required="">
                                </div>
                                <!-- <div class="form-group">
                                    <label>Status</label>
