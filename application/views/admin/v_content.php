                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php foreach($record->result() as $row){ ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td align="center"><a href="<?php echo base_url().'dashboard/contentedit/'.$row->id ?>"> <i class="glyphicon glyphicon-edit"></i></a> | <a href="<?php echo base_url().'dashboard/contenthapus/'.$row->id.'/'.$row->kategori ?>"> <i class="glyphicon glyphicon-trash"></i> </a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
